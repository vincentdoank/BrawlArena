	...
	{		
		...
		protected virtual void OnSceneGUI()
	    {
			...
			for (int i=0;i<t.PathElements.Count;i++)
			{
				...
				var fmh_49_57_638209593208415875 = Quaternion.identity; var fmh_49_113_638411956446908121 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, Quaternion.identity, .5f, new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
