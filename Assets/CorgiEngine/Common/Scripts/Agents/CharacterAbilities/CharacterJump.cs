...
{	
	...
	{	
		...
		{
			Debug.LogError("_vert input : " + _verticalInput);
			...
			if (_inputManager != null)
			{
				...
				Debug.LogError("vertical input : " + _verticalInput + " " + -_inputManager.Threshold.y + " " + gameObject.name, this);
		...
		{
			Debug.LogError("JumpDownFromOneWayPlatform");
